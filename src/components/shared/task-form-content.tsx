            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-3 p-0 bg-muted/30 rounded-lg">
              ...
              <div className="space-y-1">
                <select
                  ...
                  className="h-8 w-full px-2 py-1 border-none bg-background rounded text-sm focus:outline-none apperance-none"
                >
              ...
              <div className="space-y-1">
                <select
                  ...
                  className="h-8 w-full px-2 py-1 border border-input bg-background rounded text-sm focus:outline-none apperance-none"
                >
              ...
              <div className="space-y-1">
                <select
                  ...
                  className="h-8 w-full px-2 py-1 border-none bg-background rounded text-sm focus:outline-none"
                >
